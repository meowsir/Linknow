...
document.addEventListener("DOMContentLoaded", (event)=>{
    ...
    muteBttn.addEventListener("click", (event)=>{
        ...
        document.getElementById("bttn_mute").className = (audioMuted)? "btn btn-danger": "btn btn-success";
    });    
    muteVidBttn.addEventListener("click", (event)=>{
        ...
        document.getElementById("bttn_vid_mute").className = (videoMuted)? "btn btn-danger": "btn btn-success";
    });  
